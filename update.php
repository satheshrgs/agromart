...
{ 
  ...
  $sql="UPDATE `users` SET `password`='".$password."',`mobilenumber`='".$mobilenumber."',`address`='".$address."',`town`='".$town."',`state`='".$state."',`occupation`='".$occupation."' where email='".$email."'";
...
<table>
	...
	<tr>
	<td>Occupation:</td><td><select name="occupation"><option value="Farmer">Farmer</option>
									<option value="Consumer">Consumer</option>
									<option value="FPI">FPI</option></td>
	</tr>
